            ...
            {   test=1;
                ...
                else
                {
                    ...
                    if(transaction.amt>add.amt){
                    	printf("Withdraw unsuccessful due to INSUFFICIENT BALANCE!!");
...
void Close(void)
{
    printf("\n\n\n\nThis C Mini Project is developed by TEAM AC/DC!!!!");
    }
...
{   int choice;
    ...
    switch(choice)
    {
        case 1:new_acc();//naya aacount banauna ko lagi //ln:41
        break;
        case 2:edit();//information update ko lagi   // ln138
        break;
        case 3:transact();//transaction(paisa nikalna ra halna ko lagi) //ln 208
        break;
        case 4:see();//customer ko account check garna //ln346
        break;
        case 5:erase();//account delete garna //ln 295
        break;
        case 6:view_list();//customer ko list check garna ko lagi //ln 105
        break;
        case 7:Close();//ln 501
        break;
...
int main()
{
    char pass[10],password[10]="kantipur";
    int i=0;
